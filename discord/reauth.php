...
// Build the authorization URL with all the scopes we need for webhook management
...
$auth_url .= '&scope=identify%20guilds%20guilds.channels.read'; // Now includes guilds.channels.read
